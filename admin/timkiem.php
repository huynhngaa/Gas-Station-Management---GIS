...
var data = [
	...
	while($row = $result->fetch_array()) {
		?>
		{"gia":"<?php echo number_format($row['gia']) ?>","loai":"<?php echo $row['l_ten'] ?>","tinhtp_ten":"<?php echo $row['tinhtp_ten'] ?>","qh_ten":"<?php echo $row['qh_ten'] ?>","px_ten":"<?php echo $row['px_ten'] ?>","loc":[<?php echo $row['t_lat'] ?>,<?php echo $row['t_long'] ?>], "logo":"<?php echo $row['ct_logo'] ?>", "title":"<?php echo $row['t_ten'] ?>","t_ma":"<?php echo $row['t_ma'] ?>", "icon":"images/<?php echo $row['ct_logo']  ?>"},
		<?php
	  }
?>	  
	];
