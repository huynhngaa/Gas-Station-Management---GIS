...
<script>
	...
	var data = [
		<?php $sql = "SELECT *  from trambanle a, congtydaumoi e, phuongxa b, quanhuyen c, tinhtp d, loaixangdau f , dg where e.ct_ma = dg.ct_ma and a.l_ma = f.l_ma and  a.ct_ma = e.ct_ma and  a.px_ma=b.px_ma and b.qh_ma = c.qh_ma and c.tinhtp_ma = d.tinhtp_ma";
